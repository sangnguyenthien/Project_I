...
public class Table{
    ...
    public Table(JsonObject table, String baseId, String personal_access_token)
    {
    ...
    public static String createTable(String name, JsonArray fields, String baseId, String personal_access_token){
        String endpoint = "https://api.airtable.com/v0/meta/bases/" + baseId + "/tables";
    ...
    public static JsonObject getTable(String tableId, String baseId, String personal_access_token)
    {
